...
if __name__ == '__main__':
    ...
    parser.add_argument('-cdecayfactor', type=float, default=0.9999, help='initial learning rate')
    ...
    featrue_center = Center(n_dim=net.fc.in_features, CdecayFactor=args.cdecayfactor)
    ...
    print("Settings: lr:{}, Temp:{}, WD:{}, centlr:{}, centmomentum:{}, cdecayfactor{}".format(args.lr, args.feature_Temp, args.wd, args.centlr, args.centmomentum, args.cdecayfactor),
